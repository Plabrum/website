  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10">
      <div className="flex flex-col">
        {projects.map((project, index) => (
          <div key={index}>
            ...
            />
            {index < projects.length - 1 && <div className="bg-custom-t4 h-px mx-12 rounded-full" />}
          </div>
        ))}
      </div>
      ...
      <Link
        ...
        href="/projects"
      >
        <p className="text-md text-custom-t3 uppercase tracking-widest ">See All Projects</p>
