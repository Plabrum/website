...
export default function HomePage({ abouts, projects, experiences }: Props) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-scroll scroll-smooth bg-custom-bg1">
      {/* Header */}
      <HeaderComponent showNav={showNav} homepage />

      {/* Hero */}
      <Section idName="hero" className="min-h-screen flex flex-col items-center">
      ...
      {/* About */}
      <Section idName="about" titleName="About" className=" flex flex-col items-center sm:py-40 py-20">
        <About about={about} />
      </Section>
