      ...
      >
        <Head>
          <link
            ...
            type="image/png"
            sizes="32x32"
            href={systemTheme === 'dark' ? '/favicon_dark/favicon-32x32.png' : '/favicon-32x32.png'}
          />
          <link
            id="favicon"
            rel="icon"
            type="image/png"
            sizes="16x16"
            href={systemTheme === 'dark' ? '/favicon_dark/favicon-16x16.png' : '/favicon-16x16.png'}
          />
          <link
            id="favicon"
            rel="apple-touch-icon"
            href={systemTheme === 'dark' ? '/favicon_dark/apple-touch-icon.png' : '/apple-touch-icon.png'}
          />
          <link
            id="favicon"
            rel="icon"
            type="image/png"
            sizes="192x192"
            href={systemTheme === 'dark' ? '/favicon_dark/android-chrome-192x192.png' : '/android-chrome-192x192.png'}
          />
          <link
            id="favicon"
            rel="icon"
            type="image/png"
            sizes="192x192"
            href={systemTheme === 'dark' ? '/favicon_dark/android-chrome-512x512.png' : '/android-chrome-512x512.png'}
          />
        </Head>
